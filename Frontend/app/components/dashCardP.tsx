...
export default function DashCardP({reportId, dateReported, category, issue, priority, location, status, voteCount, onInvestigating, onInProgress, onFixed, onNotStarted}: CardProps) {
    ...
    return (
        ...
        <div className = "card h-[620px] w-[260px] text-wrap rounded">
            ...
            <p className = "text-[#3242a8]"> {priority} </p>
